...
export default function OnboardingPage() {
  ...
  const completeOnboarding = async () => {
    ...
    const destination = selections.firstAction === 'write' ? '/workspace/new-draft' 
      : selections.firstAction === 'improve' ? '/workspace/import'
      : selections.firstAction === 'explore' ? '/dashboard'
      : '/dashboard';
