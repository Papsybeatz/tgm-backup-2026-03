      ...
      <div className="max-w-6xl mx-auto px-6 py-12 grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-[#D4AF37]">
          ...
          <div className="flex flex-col gap-4 mb-4">
            {COMMENTS.map(c => (
              <div key={c.author + c.time} className="bg-[#F7F9FB] rounded-lg p-4 border border-[#E2E8F0]">
          ...
          <button className="mt-2 px-4 py-2 bg-[#D4AF37] text-[#0A0F1A] rounded-lg font-bold text-sm shadow hover:shadow-md transition">
            Post Comment
          </button>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-[#D4AF37]">
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="px-3 py-1.5 bg-[#003A8C] text-white rounded-lg text-xs font-bold hover:opacity-90 transition">
              + Invite
            </button>
          </div>
