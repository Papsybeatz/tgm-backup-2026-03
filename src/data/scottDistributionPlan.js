...
export const SCOTT_EMAIL_SEQUENCES = [
  {
    ...
    emails: [
      ['Your NY Grant Readiness Score', 'Run NY Fit Score'],
      ['Top NY funders and what they look for', 'Explore NY funder intelligence'],
      ['Why NY proposals get rejected', 'Run Checkmate'],
      ['NY deadlines coming up', 'Start a draft'],
      ['Lifetime Access for NY orgs (Limited)', 'Unlock Lifetime Access'],
    ],
  },
  {
    id: 'consultant',
