...
- Name: grants-master-landing-backup-2026-04-15\grants-master-landing\GrantsMasterVite\restore_points\frontend\tests\e2e\launch-readiness.spec.js >> Launch Readiness >> Dashboard loads after login
- Location: grants-master-landing-backup-2026-04-15\grants-master-landing\GrantsMasterVite\restore_points\frontend\tests\e2e\launch-readiness.spec.js:38:3
...
Locator: locator('[data-testid="login-email"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="login-email"]')
