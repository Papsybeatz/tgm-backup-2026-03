...
- Name: tests\e2e\launch-readiness.spec.js >> Launch Readiness >> Dashboard loads after login
- Location: tests\e2e\launch-readiness.spec.js:38:3
...
```ts
  1  | 
  2  | // Example Playwright test for launch readiness (frontend)
