...
export function ghostModuleSweep({ projectRoot }) {
  ...
  function scan(dir) {
    ...
    for (const entry of entries) {
      ...
      // --- Skip ED's own modules to avoid self-quarantine ---
      if (fullPath.includes("backend/ed/modules/ghostModuleSweep.js")) continue;
      if (fullPath.includes("backend/ed/modules")) continue;
